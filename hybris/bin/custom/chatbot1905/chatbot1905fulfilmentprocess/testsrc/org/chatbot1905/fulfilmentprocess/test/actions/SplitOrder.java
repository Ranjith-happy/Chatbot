 ...
 */
package org.chatbot1905.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(Chatbot1905FulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(Chatbot1905FulfilmentProcessConstants.PARENT_PROCESS);
