 ...
 */
package org.chatbot1905.test.setup;
...
import org.chatbot1905.test.constants.Chatbot1905TestConstants;
import org.chatbot1905.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = Chatbot1905TestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/chatbot1905test/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/chatbot1905test/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/chatbot1905test/import/cstickets.impex");
			...
			importImpexFile(context, "/chatbot1905test/import/csquotes.impex");
		}
	}
}
