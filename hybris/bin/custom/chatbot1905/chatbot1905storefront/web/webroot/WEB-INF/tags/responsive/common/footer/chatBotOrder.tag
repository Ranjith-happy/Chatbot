 ...
 <div id="chatbox-area" data-toggle="1">
    ...
    <div class="content">
      ...
      <div class="chat-message-group">
        <div class="chat-messages">
          <div class="message">How may I help you for this order ${orderCode}</div>
  ...
  <footer class="card-footer" id="chatBox-textbox">
    <div class="textContent">
      <textarea id="chatTextareaOrder" data-value="${orderCode}" class="chat-textarea" placeholder="Type message here..."></textarea>
    ...
    <a class="button-chatbot-order is-white" data-value="${orderCode}" title="send message"><i class="fa fa-paper-plane" aria-hidden="true"></i></a></div>
