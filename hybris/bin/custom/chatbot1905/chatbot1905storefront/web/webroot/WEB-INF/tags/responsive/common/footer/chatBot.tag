		...
		<div class="card " id="chatBot">
			...
			<header class="card-header header-title">
				<p class="card-header-title">
					...
					Message
					<button id="livechat" style="background-color: brown">
						<b>LiveChat</b>
					</button>
				</p>
				<a class="card-header-icon" id="chat-close" title="close chatbot">
...
<i class="fa fa-times" aria-hidden="true"></i>
			...
			<div id="chatbox-area" data-toggle="1">
				<div class="card-content chat-content" id="chatbox-content">
					<div class="content">
						...
						<div class="chat-message-group">
							<div class="chat-messages">
								<div class="message">Hi ! Welcome to our store. What are
									you looking for. Do you want to search any of our products?</div>
								<div>
		...
		<div class="card" id="liveChat" hidden>
			...
			<header class="card-header header-title">
				<p class="card-header-title">
					...
					<button id="botchat" style="background-color: brown">
						<b>Chat Bot</b>
					</button>
					<button id="viewAns" style="background-color: brown">
						<b>ViewAns</b>
					</button>
				</p>
				<a class="card-header-icon" id="live-chat-close"
					title="close chatbot"> <span class="icon"> <i
						class="fa fa-close"></i>
				</span>
				</a>
			</header>
			<div id="chatbox-area" data-toggle="1">
				<div class="card-content chat-content" id="chatbox-content">
					<div class="content">
						...
						<div class="show-questions"></div>
						<div class="chat-message-group typing-text1" hidden></div>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="card" id="viewAnswers" hidden = "true">
			<header class="card-header header-title">
				<p class="card-header-title">
					View Answers
					<button id="botchat1" style="background-color: brown">
						<b>Chat Bot</b>
					</button>
					<button id="livechat1" style="background-color: brown">
						<b>LiveChat</b>
					</button>
				</p>
				<a class="card-header-icon" id="view-ans-close"
					title="close chatbot"> <span class="icon"> <i
						class="fa fa-close"></i>
				</span>
				</a>
			...
			<div id="chatbox-area" data-toggle="1">
				<div class="card-content chat-content">
					<div class="content">
						<div class="show-questionsAns"></div>
					</div>
				</div>
			</div>
		</div>
	...
	<div id="notification" style="display: none;">
		<span class="dismiss"><a href="#">x</a></span>
	</div>
