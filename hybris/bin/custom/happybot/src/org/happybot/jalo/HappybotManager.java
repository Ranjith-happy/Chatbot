...
/**
 * This is the extension manager of the Happybot extension.
 */
public class HappybotManager extends GeneratedHappybotManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(HappybotManager.class.getName());
	 ...
	 */
	public static HappybotManager getInstance()
	{
		return (HappybotManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				HappybotConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public HappybotManager() 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of HappybotManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of HappybotManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of HappybotManager called, current tenant: " + getTenant().getTenantID());
		}
	}
